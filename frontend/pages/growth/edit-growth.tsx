...
const useEditGrowthForm = vlens.declareHook(
  (growthData?: server.GrowthData): EditGrowthForm => ({
...
function onHeightInputModeChange(form: EditGrowthForm, newMode: string) {
  ...
  return (
    <div className="add-growth-page">
      <div className="auth-card">
        ...
        {(form.value || form.feet || form.inches) && (
          <div className="measurement-preview">
            <h3>Preview</h3>
            <p>
              Updated {form.measurementType}:{" "}
              {form.measurementType === "height" &&
              form.unit === "in" &&
              form.heightInputMode === "feet-inches" ? (
                <>
